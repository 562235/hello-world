...
int lcd_draw_jpg(unsigned int x,unsigned int y,const char *pjpg_path,char *pjpg_buf,unsigned int jpg_buf_size,unsigned int jpg_half)  
{
	...
	for(o = 0; o < 120; o++)
	{
		memcpy(g_pfb_memory + o*800+0, photo_data+o*800+0, 800*4);
		memcpy(g_pfb_memory + o*800+120*800, photo_data+o*800+120*800, 800*4);
		memcpy(g_pfb_memory + o*800+240*800, photo_data+o*800+240*800, 800*4);
		memcpy(g_pfb_memory + o*800+360*800, photo_data+o*800+360*800, 800*4);
		usleep(500*20);
	}
